...
public class ResumeController {
    ...
    public ResponseEntity<?> update(@Valid @PathVariable Integer id, @RequestBody ResumeRequest.UpdateDTO reqDTO, Errors errors) {
    ...
    public ResponseEntity<?> save(@Valid @RequestBody ResumeRequest.SaveDTO resumeSaveDTO, Errors errors) {
        User sessionUser = (User) session.getAttribute("sessionUser");
